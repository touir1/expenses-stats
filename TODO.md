...
- [x] **`filter.script.js` uses bare `console.log` for output summary**: lines 182–190 use `console.log` directly instead of `logSuccess`/`logWarning` from `console-output.util.js`, inconsistent with every other script
